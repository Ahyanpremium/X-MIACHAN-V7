...
await conn.send2ButtonImg(m.chat, await (await fetch('https://telegra.ph/file/b87224c29733405308e2e.png')).buffer(),  '*────────[ DASBOARD ]────────*', text, 'INFOBOT', '.info', 'OWNER', '.owner', m, {  
      quoted: ftroli,  
      contextInfo: { //forwardingScore: 99999, isForwarded: true,  
          externalAdReply: {  showAdAttribution: true, 
              title: 'Bot Wangsaf Multi Fungsi',  
              body: '© Ahyan', 
              description: 'Made With Solo AhyanMhmmd', 
              mediaType: 2,  
